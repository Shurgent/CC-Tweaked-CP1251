describe("The os library", function()
    ...
    describe("os.date", function()
        ...
        describe("produces output consistent with PUC Lua", function()
            ...
            local midnight = os.time { year = 2022, month = 12, day = 7, hour = 0, min = 45, sec = 22 }
            it("%r at 12 AM", function() expect(os.date("%r", midnight)):eq("12:45:22 AM") end)
            it("%I at 12 AM", function() expect(os.date("%I", midnight)):eq("12") end)
